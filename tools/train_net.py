...
from geo_parse.solver import make_lr_scheduler
from geo_parse.solver import make_optimizer
from geo_parse.engine.inference import inference
from geo_parse.engine.trainer import do_train
...
from geo_parse.utils.comm import synchronize, get_rank, is_pytorch_1_1_0_or_later
...
def main():
    parser = argparse.ArgumentParser(description="PyTorch PGDP Training")
    parser.add_argument(
        "--config-file",
        default="",
        metavar="FILE",
    ...
    logger = setup_logger("geo_parse", output_dir, get_rank())
